#############################################################################
# Makefile for building: signalscoin-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Sun Apr 22 12:10:23 2018
# Project:  SignalsCoin-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake RELEASE=1 -o Makefile SignalsCoin-qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -Wl,-Bstatic -lminiupnpc /tmp/SignalsCoin/src/leveldb/libleveldb.a /tmp/SignalsCoin/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -Wl,-Bdynamic -lrt -ldl -lpthread -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
...
Makefile: SignalsCoin-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) RELEASE=1 -o Makefile SignalsCoin-qt.pro
...
/tmp/SignalsCoin/src/leveldb/libleveldb.a: FORCE
	cd /tmp/SignalsCoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/tmp/SignalsCoin/build/build.h: FORCE
	cd /tmp/SignalsCoin; /bin/sh share/genbuild.sh /tmp/SignalsCoin/build/build.h
